...
import {GetPublicOffers_CreatedByBuyer_buyer_initialized} from '../../JS/DB-cloudFunctions'
...
apiRoute.get(async (req, res) => {     
    ...
    const offers = await GetPublicOffers_CreatedByBuyer_buyer_initialized(UserWallet);
