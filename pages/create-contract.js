...
export default function Description(props) {
  ...
  const downloadDescriptionValue = () => {
    ...
    const descriptionFile = new Blob(
      [
        "Description hash: " + sha256("Some text for template A testing abc") + "\r\n" + "\r\n" + "Description:" + "\r\n" +
              ...
              <ul>
                {TemplatesData.map((item) => (
                  <li
                    key={item.id}
                    className={
                      selectedTemplate === item.templateCode ? "contractCard selected" : "contractCard"
                    }
                  >
                    <input
                    ...
                    <div className='formRow'>
                      ...
                      <div className='formField'>
                        <div className='customPriceField'>
                          ...
                          >
                            {CurrenciesData.filter((item) => item.shortName === selectCurrency).map((selectedItem) => (
